...
import threading
import uuid
from typing import Awaitable, Callable, Dict, Literal, Optional, Set, Union
...
async def main() -> None:
    ...
    if not endpoint or not deployment:
        raise ValueError(
            "Both AZURE_VOICE_LIVE_ENDPOINT and AZURE_VOICE_LIVE_DEPLOYMENT environment variables must be set."
        )
